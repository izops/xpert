...
def strGetAbsenceType():
    ...
    or (
        strResponse.lower() != 'c' \
        and not strResponse.lower() in g.LST_SCRAPE_ABSENCES
    ):
        ...
        elif strResponse.lower() != 'c' \
        or not strResponse.lower() in g.LST_SCRAPE_ABSENCES:
